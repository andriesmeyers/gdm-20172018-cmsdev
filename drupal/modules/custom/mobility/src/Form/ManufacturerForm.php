...
/**
 * Form controller for Manufacturer edit forms.
 *
 * @ingroup mobility
 */
class ManufacturerForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        drupal_set_message($this->t('Created the %label Manufacturer.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        drupal_set_message($this->t('Saved the %label Manufacturer.', [
          '%label' => $entity->label(),
        ]));
    }
